...
export const Header = () => {
  ...
  return (
    ...
    >
      <div>
        <Image
          ...
          className={[
            ...
            isScrolled
              ? "w-[80px]"
              : "w-[80px] sm:w-[130px] pt-10 filter invert brightness-0",
          ].join(" ")}
          priority
        />
      </div>
      ...
      <div
        className={["flex items-center gap-5", isScrolled ? "h-full" : ""].join(
          " "
        )}
      >
        <ul
          className={[
            "uppercase hidden sm:flex items-center flex-wrap gap-3.5 text-[.8rem] font-semibold",
